  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="w-[95vw] sm:w-[90vw] lg:w-auto lg:max-w-5xl p-0 max-h-[90vh] overflow-y-auto m-4">
        ...
        <DialogDescription className="sr-only">Choose a date range by selecting start and end dates from the calendars or using predefined periods.</DialogDescription>
        {/* Header */}
