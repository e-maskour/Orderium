  ...
  useEffect(() => {
    const fetchOrderStatus = async () => {
      ...
      try {
        ...
        else if (order.status === 'in_transit' || order.status === 'in_delivery')
          status = 'in_delivery';
  ...
  if (orderStatus.status === 'canceled') {
    return (
      ...
      >
        ...
        <p style={{ fontWeight: 700, color: '#7f1d1d', margin: '0 0 0.25rem', fontSize: '1rem' }}>
          {t('orderCanceled')}
        </p>
    ...
    <div dir={dir} style={{ padding: '0.5rem 0' }}>
              ...
              <div
                ...
                style={{
                  ...
                  left:
                    dir === 'rtl'
                      ? undefined
                      : `calc(${(i / (STEPS.length - 1)) * 100}% + 1.25rem)`,
                  right:
                    dir === 'rtl'
                      ? `calc(${(i / (STEPS.length - 1)) * 100}% + 1.25rem)`
                      : undefined,
      ...
      {currentIndex >= 0 && (
        <div
          style={{
            marginTop: '1.5rem',
            background: `${STEPS[currentIndex].color}14`,
            borderRadius: '0.875rem',
            padding: '0.875rem 1rem',
            border: `1px solid ${STEPS[currentIndex].color}30`,
          }}
        >
