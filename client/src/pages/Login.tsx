...
export default function Login() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    // Extra runtime check: fullName required when registering
    if (phoneExists === false && !data.fullName?.trim()) {
      setError('fullName', { message: 'nameRequired' });
      return;
    }
    setIsLoading(true);
    try {
      ...
      >
        ...
        >
          ...
          >
            ...
            {isExistingAccount && (
              <HandMetal
                ...
                color={PRI}
                strokeWidth={2}
                style={{ marginInlineStart: '0.4rem', flexShrink: 0 }}
              />
            )}
          </h2>
          {isExistingAccount && customerName && (
            ...
            >
              <span style={{ fontSize: '0.8125rem', fontWeight: 600, color: PRI_DARK }}>
                {customerName}
              </span>
            </div>
          )}
          ...
          >
                ...
                >
                  <Loader2
                    style={{
                      ...
                      height: '0.875rem',
                      color: PRI,
                      animation: 'clt-spin 0.8s linear infinite',
                    }}
                  />
              ...
              <div>
                ...
                {errors.fullName && (
                  ...
                  >
                    ...
                    />
                    <span style={{ fontSize: '0.8rem', color: '#ef4444' }}>
                      {t(errors.fullName.message as TranslationKey)}
                    </span>
                  </div>
                )}
              </div>
            ...
            <div>
              ...
              {isNewAccount && (
                <p style={{ fontSize: '0.775rem', color: '#94a3b8', margin: '0.3rem 0 0' }}>
