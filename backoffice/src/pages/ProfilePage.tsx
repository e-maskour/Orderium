        ...
        >
          ...
          {card(
            ...
            >
              ...
              <div style={{ textAlign: isRTL ? 'right' : 'left' }}>
                ...
                >
                  <Shield
                    style={{ width: '0.8125rem', height: '0.8125rem', color: '#10b981' }}
                    strokeWidth={2}
                  />
                  <span
                    style={{
          ...
          {card(
            <>
              {sectionTitle(
                <User
                  style={{ width: '0.875rem', height: '0.875rem', color: '#6366f1' }}
                  strokeWidth={2}
                />,
                t('accountInfo'),
              )}
          ...
          {card(
            <>
              {sectionTitle(
                <Lock
                  style={{ width: '0.875rem', height: '0.875rem', color: '#f59e0b' }}
                  strokeWidth={2}
                />,
                t('securitySection'),
              )}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      <KeyRound
                        style={{ width: '0.8125rem', height: '0.8125rem', color: '#6b7280' }}
                        strokeWidth={2}
                      />
                      {t('newPassword')}
                    </span>
                ...
                <div>
                  ...
                  <Password
                    ...
                    inputStyle={{
                      ...
                      fontFamily,
                      borderColor:
                        confirmPassword && newPassword !== confirmPassword ? '#ef4444' : undefined,
                    }}
                    style={{ width: '100%', display: 'block' }}
                    pt={{ input: { dir: isRTL ? 'rtl' : 'ltr' } }}
                  />
