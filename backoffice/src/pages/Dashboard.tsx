            ...
            >
              <div className="p-8">
                <div className="flex items-center gap-5">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-slate-800 mb-1.5 group-hover:text-green-600 transition-colors">{t('pos')}</h3>
                    <p className="text-sm text-slate-500 leading-relaxed">{t('createOrder') || 'Create orders for customers'}</p>
                  </div>
                </div>
              </div>
            </Link>
