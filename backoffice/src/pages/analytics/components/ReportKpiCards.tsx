...
const COLOR_STYLES: Record<string, { text: string; icon: string; bg: string; border: string }> = {
  green: { text: 'var(--green-700)', icon: 'pi-arrow-up-right', bg: 'var(--green-50)', border: 'var(--green-200)' },
  red: { text: 'var(--red-600)', icon: 'pi-arrow-down-right', bg: 'var(--red-50)', border: 'var(--red-200)' },
  blue: { text: 'var(--blue-700)', icon: 'pi-chart-bar', bg: 'var(--blue-50)', border: 'var(--blue-200)' },
  orange: { text: 'var(--orange-600)', icon: 'pi-shopping-bag', bg: 'var(--orange-50)', border: 'var(--orange-200)' },
  purple: { text: 'var(--purple-700)', icon: 'pi-file', bg: 'var(--purple-50)', border: 'var(--purple-200)' },
  teal: { text: '#0d9488', icon: 'pi-users', bg: '#f0fdfa', border: '#99f6e4' },
};

const DEFAULT_ICONS: string[] = ['pi-chart-line', 'pi-shopping-bag', 'pi-percentage', 'pi-wallet', 'pi-box'];
            ...
            >
              ...
              <div className="flex align-items-center justify-content-between">
                ...
                <div style={{
                  ...
                  <i className={`pi ${iconClass}`} style={{ fontSize: '0.875rem', color: style.text }} />
                </div>
              </div>
