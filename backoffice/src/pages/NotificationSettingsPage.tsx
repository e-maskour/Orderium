          ...
          {(Object.keys(CATEGORY_LABELS) as NotificationTemplateCategory[]).map((category) => {
            ...
            return (
              <div key={category} className="surface-card border-round shadow-1 overflow-hidden">
                {/* Category Header */}
                <div
                  className="px-4 py-3 flex align-items-center gap-2 border-bottom-1 surface-border"
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex align-items-center gap-2 flex-wrap">
                          <span className="font-medium text-900 text-sm">{tpl.titleFr}</span>
                          <Tag
                        ...
                        {tpl.description && (
                          <p
                            className="text-500 text-xs mt-1 mb-0 white-space-nowrap overflow-hidden text-overflow-ellipsis"
          ...
          <div className="flex flex-column gap-4">
            ...
            <div className="flex flex-column gap-2">
              ...
              <span className="text-xs text-500">
                Variables disponibles : <code>{'{{clientName}}'}</code>,{' '}
                <code>{'{{orderNumber}}'}</code>, <code>{'{{driverName}}'}</code>, etc.
              </span>
            </div>
              ...
              <Button
                ...
                onClick={() =>
                  toastConfirm(
                    ...
                    () => resetOneMutation.mutate(editingTemplate.key),
                    { variant: 'warning', confirmLabel: 'Réinitialiser' },
                  )
                }
              />
      ...
      >
        <div className="flex flex-column gap-4">
          <p className="text-700 m-0">
            Cette action va réinitialiser <strong>tous</strong> les modèles de notification à leurs
            valeurs d'usine. Les modifications que vous avez apportées seront perdues.
          </p>
