    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* ── LEFT BRAND PANEL ─────────────────────────────── */}
          <div className="login-left-panel login-panel-left" style={{
            flex: '1 1 45%',
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{
                ...
                <h2 style={{ fontSize: '2rem', fontWeight: 800, color: '#fff', lineHeight: 1.2, marginBottom: '0.75rem', margin: '0 0 0.75rem' }}>
                  {t('loginHeroTitle')}<br />
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                {featureCards.map(({ icon: Icon, label }) => (
                  <div key={label} className="login-feature-card" style={{
          ...
          {/* ── RIGHT FORM PANEL ─────────────────────────────── */}
          <div className="login-right-panel login-panel-right" style={{
            flex: '1 1 55%',
            background: '#fff',
            ...
            <div style={{ marginBottom: '2rem' }}>
              <div style={{
                ...
                background: `rgba(35,90,228,0.08)`, borderRadius: '999px',
                padding: '0.25rem 0.75rem', marginBottom: '1rem',
              }}>
                <Shield style={{ width: '0.875rem', height: '0.875rem', color: BRAND }} />
                <span style={{ fontSize: '0.75rem', fontWeight: 600, color: BRAND }}>{t('secureAdminAccess')}</span>
              </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              <div>
                <label htmlFor="login-phone" style={{
                  ...
                  color: '#374151', marginBottom: '0.5rem', letterSpacing: '0.01em',
                }}>
                  {t('phoneNumber')}
                </label>
                <div className="login-input-wrap">
                  ...
                  <InputText
                    ...
                    required
                    disabled={isLoading}
                    style={{ width: '100%', borderRadius: '0.75rem', border: '1.5px solid #e2e8f0', fontSize: '0.9375rem', transition: 'border-color 0.2s' }}
                  />
                </div>
              </div>
              ...
              {error && (
                <div style={{
                  ...
                  <span style={{ color: '#ef4444', fontSize: '1rem', lineHeight: 1, marginTop: '0.05rem' }}>⚠</span>
