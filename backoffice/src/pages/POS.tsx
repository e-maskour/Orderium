...
export default function POS() {
  ...
  useEffect(() => {
    (searchKeyboard.ref as React.RefObject<HTMLInputElement>)?.current?.focus();
  ...
  const clearCart = () => {
    toastConfirm(t('confirmClearCart') || 'Vider le panier ?', () => setCart([]), {
      variant: 'destructive',
      confirmLabel: t('clearCart') || 'Vider',
    });
  };
    ...
    <>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem', width: '100%' }}>
          ...
          >
            <ShoppingCart
              style={{ width: '1rem', height: '1rem', color: '#93b4f8' }}
              strokeWidth={2}
            />
          </div>
      ...
      {/* ── Items List ── */}
      <div
        style={{ flex: 1, overflowY: 'auto', padding: '0.625rem 0.75rem', background: '#f8fafc' }}
      >
        {cart.length === 0 ? (
          <div
            style={{
          ...
          >
            ...
            >
              <ShoppingCart
                style={{ width: '1.75rem', height: '1.75rem', color: '#cbd5e1' }}
                strokeWidth={1.5}
              />
            </div>
            <p
                  ...
                  >
                    ...
                    >
                      {item.product.imageUrl ? (
                        ...
                        <Package
                          style={{ width: '1.125rem', height: '1.125rem', color: '#cbd5e1' }}
                        />
                      )}
                    </div>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <Button
              ...
              icon={
                <ShoppingBag style={{ width: '0.875rem', height: '0.875rem' }} strokeWidth={2.5} />
              }
            ...
            <Button
              label={t('payment') || 'Pay'}
              icon={
                <ChevronRight style={{ width: '0.875rem', height: '0.875rem' }} strokeWidth={2.5} />
              }
          ...
          {!selectedCustomer && (
            <button
              ...
              style={{
                ...
                border: '1px dashed rgba(35,90,228,0.4)',
                color: '#235ae4',
                fontSize: '0.6875rem',
                fontWeight: 600,
                cursor: 'pointer',
          ...
          >
            ...
            <Button
              ...
              icon={
                <User
                  style={{
                    width: selectedCustomer ? '0.75rem' : '0.875rem',
                    height: selectedCustomer ? '0.75rem' : '0.875rem',
            ...
            {totalPages > 1 && (
              ...
              >
                ...
                {(() => {
                  ...
                  for (let i = 0; i < Math.min(maxVisible, totalPages); i++) pages.push(start + i);
                  return pages.map((n) => (
                    <button
                      key={n}
                      ...
                      style={{
                        ...
                        height: '2rem',
                        borderRadius: '0.5rem',
                        border: n === currentPage ? '1px solid #235ae4' : '1px solid #e5e7eb',
                        background: n === currentPage ? '#235ae4' : '#fff',
