      ...
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        ...
        {isLoading ? (
          ...
          <div style={{ textAlign: 'center', paddingTop: '3rem', paddingBottom: '3rem', background: '#ffffff', borderRadius: '0.5rem', border: '1px solid #e2e8f0' }}>
            ...
            <p style={{ color: '#64748b' }}>{t('noWarehousesFound')}</p>
          </div>
        ) : (
        ...
        >
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: '#334155', marginBottom: '0.25rem' }}>{t('address')}</label>
              <span style={{ position: 'relative', display: 'block', width: '100%' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: '#334155', marginBottom: '0.25rem' }}>{t('city')}</label>
              <InputText
                type="text"
                value={formData.city}
            ...
            <div style={{ display: 'flex', gap: '0.75rem', paddingTop: '1rem' }}>
              <Button type="button" label={t('cancel')} onClick={handleCloseModal} outlined style={{ flex: 1 }} />
              <Button
                type="submit"
