      ...
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        ...
        >
          ...
          >
            ...
            <Column
              ...
              body={(row: Sequence) => (
                <span style={{ fontSize: '0.875rem', color: '#475569' }}>
                  {entityTypeOptions.find((opt) => opt.value === row.entityType)?.label ||
                    row.entityType}
                </span>
              )}
            />
            ...
            />
            <Column
              field="nextDocumentNumber"
              header={t('nextDocumentNumber')}
              sortable
              body={(row: Sequence) => (
                <span
                  style={{
          ...
          >
            ...
            <div>
              ...
              <Dropdown
                ...
                onChange={(e) =>
                  setFormData({ ...formData, entityType: e.value as SequenceEntityType })
                }
            ...
            <div className="form-grid-2">
              ...
              <div>
                ...
                <InputText
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, numberLength: parseInt(e.target.value) })
                  }
                  disabled={!!editingSequence && editingSequence.nextNumber > 1}
                  required
                  style={{ width: '100%' }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <Checkbox
                  ...
                  onChange={() =>
                    !(editingSequence && editingSequence.nextNumber > 1) &&
                    setFormData({ ...formData, yearInPrefix: !formData.yearInPrefix })
                  }
                  disabled={!!editingSequence && editingSequence.nextNumber > 1}
                />
                <label
                  style={{ fontSize: '0.875rem', color: '#334155' }}
                >{`${t('includeYearInPrefix')} (2025)`}</label>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <Checkbox
                  ...
                  onChange={() =>
                    !(editingSequence && editingSequence.nextNumber > 1) &&
                    setFormData({ ...formData, trimesterInPrefix: !formData.trimesterInPrefix })
                  }
                  disabled={!!editingSequence && editingSequence.nextNumber > 1}
                />
                <label
                  style={{ fontSize: '0.875rem', color: '#334155' }}
                >{`${t('includeTrimesterInPrefix')} (01, 04, 07, 10)`}</label>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <Checkbox
                  ...
                  onChange={() =>
                    ...
                    !(editingSequence && editingSequence.nextNumber > 1) &&
                    setFormData({ ...formData, monthInPrefix: !formData.monthInPrefix })
                  }
                  disabled={
                    formData.trimesterInPrefix ||
                    (!!editingSequence && editingSequence.nextNumber > 1)
                ...
                <label
                  style={{ fontSize: '0.875rem', color: '#334155' }}
                >{`${t('includeMonthInPrefix')} (12)${formData.trimesterInPrefix ? ' (désactivé par trimestre)' : ''}`}</label>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <Checkbox
                  ...
                  onChange={() =>
                    !(editingSequence && editingSequence.nextNumber > 1) &&
                    setFormData({ ...formData, dayInPrefix: !formData.dayInPrefix })
                  }
                  disabled={!!editingSequence && editingSequence.nextNumber > 1}
                />
                <label
                  style={{ fontSize: '0.875rem', color: '#334155' }}
                >{`${t('includeDayInPrefix')} (01)`}</label>
              </div>
            ...
            {previewSequence && (
              ...
              >
                <div
                  style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#1e3a8a' }}
                >
