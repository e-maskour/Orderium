        ...
        >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div>
                    ...
                    <select
                        value={form.brand}
                        onChange={(e) => setForm({ ...form, brand: e.target.value as CreatePrinterDTO['brand'] })}
                        style={inputStyle}
                    >
                        {BRAND_OPTIONS.map((b) => (
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            setForm({ ...form, connectionType: e.target.value as CreatePrinterDTO['connectionType'] })
                        }
                        style={inputStyle}
                    >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={(e) => setForm({ ...form, paperWidth: parseInt(e.target.value) as CreatePrinterDTO['paperWidth'] })}
                        style={inputStyle}
                    >
                        {PAPER_WIDTHS.map((w) => (
...
export default function Printers() {
    ...
    const handleDelete = (printer: IPrinter) => {
        if (window.confirm(t('deletePrinterConfirm'))) {
    ...
    const jobsMeta = jobsResponse?.metadata ?? { total: 0, limit: 20, offset: 0, hasNext: false, hasPrev: false };
            ...
            <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                ...
                >
                    ...
                    <div style={{ fontSize: '0.875rem', color: '#475569' }}>
                        <strong>{t('platformDetection')}:</strong>{' '}
                ...
                {activeTab === 'printers' && (
                    <>
                        {isLoading ? (
                            ...
                            >
                                <Printer style={{ width: 48, height: 48, color: '#cbd5e1', margin: '0 auto 1rem' }} />
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                            ...
                                            <div>
                                                ...
                                                <div style={{ fontSize: '0.8125rem', color: '#64748b' }}>
                                                    ...
                                                    {CONNECTION_OPTIONS.find((c) => c.value === printer.connectionType)?.label} ·{' '}
