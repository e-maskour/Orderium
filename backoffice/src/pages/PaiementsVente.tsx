...
export default function PaiementsVente() {
  ...
  const loadPayments = async () => {
    try {
      ...
      // Filter for sales payments (those with customerId or sales invoices)
      const salesPayments = data.filter(p => p.customerId);
      setPayments(salesPayments);
    } catch (error) {
    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto">
        <PageHeader
          ...
          subtitle="Gérez les paiements reçus des clients"
        />
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-emerald-600">{totalAmount.toFixed(2)} MAD</p>
              </div>
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Rechercher par facture, client, référence..."
              value={searchTerm}
