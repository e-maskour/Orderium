      ...
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <KpiGrid count={3}>
            ...
            <KpiCard label={t('totalAmount')} value={`${totalAmount.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} ${language === 'ar' ? 'د.م' : 'DH'}`} icon={Wallet} color="emerald" />
        ...
        <div style={{ background: '#ffffff', borderRadius: '0.5rem', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
          <style>{`
            .pv-datatable .p-datatable-thead > tr > th { background: #f8fafc; padding: 1rem 1.5rem; font-size: 0.75rem; font-weight: 600; color: #475569; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 1px solid #e2e8f0; }
            .pv-datatable .p-datatable-tbody > tr > td { padding: 1rem 1.5rem; border-bottom: 1px solid #e2e8f0; font-size: 0.875rem; }
            ...
            .pv-datatable .p-paginator { border: none; border-bottom: 1px solid #e2e8f0; background: #f8fafc; padding: 0.375rem 0.75rem; border-radius: 0; }
            .pv-datatable .p-paginator .p-paginator-pages .p-paginator-page.p-highlight { background: #f59e0b; color: #fff; border-color: #f59e0b; }
          `}</style>
          <DataTable
          ...
          >
            ...
            <Column header={t('client')} body={(p: Payment) => (
              <span style={{ color: '#475569' }}>{getCustomerName(p.invoiceId)}</span>
            )} />
