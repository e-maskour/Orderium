        ...
        <AdminLayout>
            <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
                <PageHeader
                    icon={Banknote}
                    title={t('caisse')}
                    subtitle={t('manageOrderPayments')}
                />
                                    ...
                                    <div className="caisse-card__header">
                                        <div className="caisse-card__order-info">
                                            ...
                                            <div style={{ minWidth: 0 }}>
                                                <div className="caisse-card__name">
                                                    {order.customerName || '—'}
                                                </div>
         ...
         ══════════════════════════════════════════════════════════ */}
            ...
            >
                <div className="caisse-drawer-header">
                    ...
                    <button
                        className="caisse-drawer-header__close"
                                    ...
                                    <div key={p.id} className="caisse-timeline-item">
                                        ...
                                        <div className="caisse-timeline-content">
                                            ...
                                            <div className="caisse-timeline-meta">
                                                {ORDER_PAYMENT_TYPE_LABELS[p.paymentType]} ·{' '}
                                                {fmtDatetime(p.dateCreated)}
