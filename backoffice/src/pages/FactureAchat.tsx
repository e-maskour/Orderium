...
import { LayoutDashboard, List, Plus, FileText, TrendingDown, Clock, CheckCircle } from 'lucide-react';
            ...
            {activeTab === 'dashboard' && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-xl p-6 border border-slate-200">
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-slate-800 mb-2">Les 3 dernières factures fournisseur</h3>
                      <div className="flex items-center justify-end gap-3">
                        <span className="text-xs text-slate-500 w-32">Fournisseur</span>
                      ...
                      {transformedFactures.slice(0, 3).map((facture) => (
                        <div key={facture.id} className="flex items-center justify-between py-2 border-b border-slate-100 last:border-0">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-bold text-red-600 w-24 text-right">{facture.amount.toFixed(2)}</span>
                          </div>
                        </div>
                      ))}
