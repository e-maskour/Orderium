                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="px-4 py-2.5 text-sm font-semibold border-2 border-slate-200 rounded-xl bg-white hover:border-blue-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all shadow-sm cursor-pointer appearance-none pr-10"
                    >
              ...
              <div className="relative">
                {chartData.every(d => d.count === 0 && d.amount === 0) ? (
                  ...
                  <div className="space-y-6 md:space-y-8">
                    {/* Line Chart */}
                    <div className="relative bg-gradient-to-br from-white via-blue-50/30 to-white rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 border border-slate-200/60 shadow-xl shadow-blue-100/50 overflow-visible z-10">
                      {/* Background decoration */}
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(59,130,246,0.08),transparent_50%)] rounded-2xl md:rounded-3xl overflow-hidden -z-10" />
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(147,197,253,0.1),transparent_50%)] rounded-2xl md:rounded-3xl overflow-hidden -z-10" />
