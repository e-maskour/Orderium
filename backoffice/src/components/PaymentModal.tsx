    ...
    try {
      ...
      if (!payment) {
        ...
        if (newTotal > invoiceTotal) {
          throw new Error(
            `${t('errorPaymentExceedsInvoice')} (${formatAmount(newTotal, 2)} ${language === 'ar' ? 'د.م' : 'DH'} > ${formatAmount(invoiceTotal, 2)} ${language === 'ar' ? 'د.م' : 'DH'})`,
          );
        }
      }
        ...
        >
          ...
          <div
            style={{
              ...
              height: '6rem',
              borderRadius: '50%',
              background: 'rgba(35,90,228,0.12)',
              pointerEvents: 'none',
            }}
          />
          <div
            ...
            <div>
              ...
              <div
                style={{
                  fontSize: '1.0625rem',
                  fontWeight: 700,
                  color: isFullyPaid ? '#34d399' : '#fbbf24',
                }}
              >
