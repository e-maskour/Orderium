      ...
      >
        ...
        <div
          style={{
            ...
            height: '22rem',
            borderRadius: '50%',
            background: 'rgba(35,90,228,0.14)',
            filter: 'blur(48px)',
            animation: 'blk-blob 14s ease-in-out infinite',
            pointerEvents: 'none',
          }}
        />
        <div
          style={{
            ...
            height: '28rem',
            borderRadius: '50%',
            background: 'rgba(26,71,184,0.10)',
            filter: 'blur(56px)',
            animation: 'blk-blob 18s ease-in-out 3s infinite reverse',
            pointerEvents: 'none',
          }}
        />
        ...
        >
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: '0.8125rem', color: '#64748b', lineHeight: 1.5 }}>
                  If you believe this is a mistake or need immediate access, reach out to your
          ...
          >
            ...
            <span style={{ fontSize: '0.75rem', color: '#94a3b8' }}>
              ...
              <strong style={{ color: '#64748b' }}>support@morocom.io</strong>
            </span>
          </div>
        </div>
      </div>
