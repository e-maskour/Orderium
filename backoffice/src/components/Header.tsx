...
interface SearchRoute {
  ...
  group: string;
  type?: 'page' | 'create' | 'settings' | 'report';
  keywords?: string[];
}
...
const APP_ROUTES: SearchRoute[] = [
  ...
  {
    path: '/dashboard',
    labels: { en: 'Dashboard', fr: 'Tableau de bord', ar: 'لوحة القيادة' },
    descriptions: {
      en: 'Overview & statistics',
      fr: 'Aperçu & statistiques',
      ar: 'نظرة عامة وإحصائيات',
    },
    icon: LayoutDashboard,
    group: 'Main',
    type: 'page',
    keywords: ['accueil', 'الرئيسية', 'home', 'stats', 'overview'],
  },
  {
    path: '/orders',
    labels: { en: 'Orders', fr: 'Commandes', ar: 'الطلبات' },
    descriptions: {
    ...
    group: 'Main',
    type: 'page',
    keywords: ['commande', 'طلب', 'order', 'livraison', 'delivery'],
  },
  {
    path: '/pos',
    labels: { en: 'Point of Sale', fr: 'Point de Vente', ar: 'نقطة البيع' },
    descriptions: {
      en: 'POS terminal & cash register',
      fr: 'Terminal de caisse',
      ar: 'كاشير ونقطة البيع',
    },
    icon: DollarSign,
    group: 'Main',
    type: 'page',
    keywords: ['pos', 'caisse', 'كاشير', 'vente', 'cash', 'register', 'terminal'],
  },
  {
    path: '/notifications',
    labels: { en: 'Notifications', fr: 'Notifications', ar: 'الإشعارات' },
    descriptions: {
      en: 'All system notifications',
      fr: 'Toutes les notifications',
      ar: 'جميع إشعارات النظام',
    },
    icon: Bell,
    group: 'Main',
    type: 'page',
    keywords: ['alertes', 'تنبيهات', 'alerts', 'messages'],
  },
  {
    path: '/delivery-persons',
    labels: { en: 'Delivery Persons', fr: 'Livreurs', ar: 'عمال التوصيل' },
    descriptions: {
      en: 'Manage delivery staff',
      fr: 'Gérer les livreurs',
      ar: 'إدارة عمال التوصيل',
    },
    icon: Truck,
    group: 'Main',
    type: 'page',
    keywords: ['livreurs', 'livreur', 'عمال التوصيل', 'توصيل', 'coursier', 'chauffeur', 'delivery'],
  },
  // ── Sales ──
  {
    path: '/devis',
    labels: { en: 'Quotes', fr: 'Devis', ar: 'عروض الأسعار' },
    descriptions: { en: 'Sales quotes list', fr: 'Liste des devis', ar: 'قائمة عروض الأسعار' },
    icon: FileCheck,
    group: 'Sales',
    type: 'page',
    keywords: ['devis', 'عرض سعر', 'quote', 'offre', 'cotation', 'proposal'],
  },
  {
    path: '/devis/create',
    labels: { en: 'New Quote', fr: 'Nouveau Devis', ar: 'عرض سعر جديد' },
    descriptions: {
      en: 'Create a sales quote',
    ...
    group: 'Sales',
    type: 'create',
    keywords: ['créer devis', 'nouveau devis', 'إنشاء عرض', 'new quote', 'create quote'],
  },
  {
    path: '/bons-livraison',
    labels: { en: 'Delivery Notes', fr: 'Bons de Livraison', ar: 'وصولات التسليم' },
    descriptions: {
      en: 'Delivery notes list',
      fr: 'Liste des bons de livraison',
      ar: 'قائمة وصولات التسليم',
    },
    icon: PackageCheck,
    group: 'Sales',
    type: 'page',
    keywords: ['bon livraison', 'livraison', 'وصل تسليم', 'bl', 'shipping'],
  },
  {
    path: '/bons-livraison/create',
    labels: { en: 'New Delivery Note', fr: 'Nouveau Bon de Livraison', ar: 'وصل تسليم جديد' },
    descriptions: {
      en: 'Create a delivery note',
      fr: 'Créer un bon de livraison',
      ar: 'إنشاء وصل تسليم',
    },
    icon: PackageCheck,
    group: 'Sales',
    type: 'create',
    keywords: ['nouveau bon livraison', 'créer livraison', 'وصل تسليم جديد'],
  },
  {
    path: '/factures/vente',
    labels: { en: 'Sales Invoices', fr: 'Factures de Vente', ar: 'فواتير البيع' },
    descriptions: {
      en: 'Sales invoices list',
      fr: 'Liste des factures de vente',
      ar: 'قائمة فواتير البيع',
    },
    icon: FileText,
    group: 'Sales',
    type: 'page',
    keywords: ['facture vente', 'فاتورة بيع', 'invoice', 'billing'],
  },
  {
    path: '/factures/vente/create',
    labels: { en: 'New Sales Invoice', fr: 'Nouvelle Facture de Vente', ar: 'فاتورة بيع جديدة' },
    descriptions: {
      en: 'Create a sales invoice',
      fr: 'Créer une facture de vente',
      ar: 'إنشاء فاتورة بيع',
    },
    icon: FileText,
    group: 'Sales',
    type: 'create',
    keywords: ['nouvelle facture vente', 'فاتورة بيع جديدة', 'new invoice'],
  },
  {
    path: '/paiements-vente',
    labels: { en: 'Sales Payments', fr: 'Paiements de Vente', ar: 'مدفوعات البيع' },
    descriptions: {
      en: 'Track sales payments & receipts',
      fr: 'Suivi des paiements de vente',
      ar: 'تتبع مدفوعات البيع',
    },
    icon: Wallet,
    group: 'Sales',
    type: 'page',
  ...
  {
    path: '/customers',
    labels: { en: 'Customers', fr: 'Clients', ar: 'العملاء' },
    descriptions: {
      en: 'Manage your customers',
      fr: 'Gérer votre clientèle',
      ar: 'إدارة قائمة العملاء',
    },
    icon: UserCircle,
    group: 'Sales',
    type: 'page',
    keywords: ['clients', 'العملاء', 'customers', 'clientèle', 'buyer', 'acheteur'],
  },
  {
    path: '/customers/create',
    labels: { en: 'New Customer', fr: 'Nouveau Client', ar: 'عميل جديد' },
    descriptions: {
    ...
    group: 'Sales',
    type: 'create',
    keywords: ['nouveau client', 'عميل جديد', 'create customer', 'add client'],
  },
  // ── Purchases ──
  {
    path: '/demande-prix',
    labels: { en: 'Price Requests', fr: 'Demandes de Prix', ar: 'طلبات الأسعار' },
    descriptions: {
      en: 'Supplier price requests (RFQ)',
      fr: 'Demandes de prix fournisseurs',
      ar: 'طلبات أسعار من الموردين',
    },
    icon: DollarSign,
    group: 'Purchases',
    type: 'page',
    keywords: ['demande prix', 'طلب سعر', 'rfq', 'tarif', 'استفسار'],
  },
  {
    path: '/demande-prix/create',
    labels: { en: 'New Price Request', fr: 'Nouvelle Demande de Prix', ar: 'طلب سعر جديد' },
    descriptions: {
      en: 'Create a new RFQ',
      fr: 'Créer une demande de prix',
      ar: 'إنشاء طلب سعر جديد',
    },
    icon: DollarSign,
    group: 'Purchases',
    type: 'create',
    keywords: ['nouvelle demande prix', 'طلب سعر جديد', 'new rfq'],
  },
  {
    path: '/bon-achat',
    labels: { en: 'Purchase Orders', fr: "Bons d'Achat", ar: 'أوامر الشراء' },
    descriptions: {
      en: 'Purchase orders list',
      fr: "Liste des bons d'achat",
      ar: 'قائمة أوامر الشراء',
    },
    icon: ShoppingBag,
    group: 'Purchases',
    type: 'page',
    keywords: ["bon d'achat", 'achat', 'أوامر الشراء', 'po', 'purchase order', 'commande achat'],
  },
  {
    path: '/bon-achat/create',
    labels: { en: 'New Purchase Order', fr: "Nouveau Bon d'Achat", ar: 'أمر شراء جديد' },
    descriptions: {
      en: 'Create a purchase order',
      fr: "Créer un bon d'achat",
      ar: 'إنشاء أمر شراء',
    },
    icon: ShoppingBag,
    group: 'Purchases',
    type: 'create',
    keywords: ["nouveau bon d'achat", 'أمر شراء جديد', 'new po'],
  },
  {
    path: '/factures/achat',
    labels: { en: 'Purchase Invoices', fr: "Factures d'Achat", ar: 'فواتير الشراء' },
    descriptions: {
      en: 'Purchase invoices list',
      fr: "Liste des factures d'achat",
      ar: 'قائمة فواتير الشراء',
    },
    icon: Receipt,
    group: 'Purchases',
    type: 'page',
    keywords: ['facture achat', 'فاتورة شراء', 'vendor invoice', 'bill'],
  },
  {
    path: '/factures/achat/create',
    labels: { en: 'New Purchase Invoice', fr: "Nouvelle Facture d'Achat", ar: 'فاتورة شراء جديدة' },
    descriptions: {
      en: 'Create a purchase invoice',
      fr: "Créer une facture d'achat",
      ar: 'إنشاء فاتورة شراء',
    },
    icon: Receipt,
    group: 'Purchases',
    type: 'create',
    keywords: ['nouvelle facture achat', 'فاتورة شراء جديدة', 'new bill'],
  },
  {
    path: '/paiements-achat',
    labels: { en: 'Purchase Payments', fr: "Paiements d'Achat", ar: 'مدفوعات الشراء' },
    descriptions: {
      en: 'Track supplier payments',
      fr: "Suivi des paiements d'achat",
      ar: 'تتبع مدفوعات الموردين',
    },
    icon: Wallet,
    group: 'Purchases',
    type: 'page',
    keywords: ['paiements achat', 'مدفوعات الشراء', 'règlement fournisseur'],
  },
  {
    path: '/fournisseurs',
    labels: { en: 'Suppliers', fr: 'Fournisseurs', ar: 'الموردون' },
    descriptions: {
      en: 'Manage your suppliers',
      fr: 'Gérer vos fournisseurs',
      ar: 'إدارة قائمة الموردين',
    },
    icon: Truck,
    group: 'Purchases',
    type: 'page',
    keywords: ['fournisseurs', 'الموردون', 'vendors', 'suppliers', 'prestataire'],
  },
  {
    path: '/fournisseurs/create',
    labels: { en: 'New Supplier', fr: 'Nouveau Fournisseur', ar: 'مورد جديد' },
    descriptions: {
      en: 'Create a new supplier',
      fr: 'Créer un nouveau fournisseur',
      ar: 'إنشاء مورد جديد',
    },
    icon: Truck,
    group: 'Purchases',
    type: 'create',
    keywords: ['nouveau fournisseur', 'مورد جديد', 'new vendor', 'add supplier'],
  },
  // ── Inventory ──
  {
    path: '/products',
    labels: { en: 'Products', fr: 'Produits', ar: 'المنتجات' },
    descriptions: {
      en: 'Browse & manage products',
      fr: 'Parcourir & gérer les produits',
      ar: 'تصفح وإدارة المنتجات',
    },
    icon: Package,
    group: 'Inventory',
    type: 'page',
    keywords: ['produits', 'المنتجات', 'articles', 'catalogue', 'sku', 'items'],
  },
  {
    path: '/products/create',
    labels: { en: 'New Product', fr: 'Nouveau Produit', ar: 'منتج جديد' },
    descriptions: {
    ...
    group: 'Inventory',
    type: 'create',
    keywords: ['nouveau produit', 'منتج جديد', 'add product', 'new sku'],
  },
  {
    path: '/categories',
    labels: { en: 'Categories', fr: 'Catégories', ar: 'التصنيفات' },
    descriptions: {
      en: 'Product category management',
      fr: 'Gestion des catégories',
      ar: 'إدارة تصنيفات المنتجات',
    },
    icon: FolderTree,
    group: 'Inventory',
    type: 'page',
  ...
  },
  {
    ...
    descriptions: {
      en: 'Warehouses & storage locations',
      fr: 'Entrepôts & emplacements de stockage',
      ar: 'المستودعات ومواقع التخزين',
    },
    icon: Building2,
    group: 'Inventory',
    type: 'page',
    keywords: ['entrepôts', 'dépôt', 'depot', 'المستودعات', 'storage', 'location', 'magasin'],
  },
  {
    path: '/stock-movements',
    labels: { en: 'Stock Movements', fr: 'Mouvements de Stock', ar: 'حركات المخزون' },
    descriptions: {
      en: 'Stock movement history & log',
      fr: 'Historique des mouvements de stock',
      ar: 'سجل حركات المخزون',
    },
    icon: TrendingUp,
    group: 'Inventory',
    type: 'report',
    keywords: ['mouvements stock', 'حركات المخزون', 'stock log', 'mouvement'],
  },
  {
    path: '/inventory-adjustments',
    labels: { en: 'Inventory Adjustments', fr: "Ajustements d'Inventaire", ar: 'تعديلات المخزون' },
    descriptions: {
      en: 'Adjust & correct stock levels',
      fr: 'Ajuster les niveaux de stock',
      ar: 'تعديل وتصحيح مستويات المخزون',
    },
    icon: BarChart2,
    group: 'Inventory',
    type: 'page',
    keywords: ["ajustements d'inventaire", 'inventaire', 'تعديلات المخزون', 'stock count'],
  },
  // ── Drive ──
  {
    path: '/drive',
    labels: { en: 'Drive', fr: 'Drive', ar: 'Drive' },
    descriptions: {
      en: 'Files, documents & cloud storage',
      fr: 'Fichiers, documents & stockage cloud',
      ar: 'الملفات والمستندات والتخزين',
    },
    icon: HardDrive,
    group: 'Drive',
    type: 'page',
  ...
  {
    path: '/configurations',
    labels: { en: 'Configurations', fr: 'Configurations', ar: 'الإعدادات العامة' },
    descriptions: {
      en: 'General app settings',
      fr: "Paramètres généraux de l'app",
      ar: 'إعدادات التطبيق العامة',
    },
    icon: Settings,
    group: 'Settings',
    type: 'settings',
    keywords: ['paramètres', 'إعدادات', 'settings', 'config', 'réglages'],
  },
  {
    path: '/configurations/taxes',
    labels: { en: 'Taxes', fr: 'Taxes', ar: 'الضرائب' },
    descriptions: {
      en: 'Tax rates & configuration',
      fr: 'Configuration des taxes & TVA',
      ar: 'معدلات الضرائب والإعدادات',
    },
    icon: Settings,
    group: 'Settings',
    type: 'settings',
    keywords: ['taxes', 'tva', 'الضرائب', 'vat', 'impôts', 'fiscal'],
  },
  {
    path: '/configurations/currencies',
    labels: { en: 'Currencies', fr: 'Devises', ar: 'العملات' },
    descriptions: {
      en: 'Currency & exchange rates',
      fr: 'Devises & taux de change',
      ar: 'العملات وأسعار الصرف',
    },
    icon: DollarSign,
    group: 'Settings',
    type: 'settings',
    keywords: ['devises', 'monnaie', 'العملات', 'currency', 'exchange rate', 'forex'],
  },
  {
    path: '/configurations/payment-terms',
    labels: { en: 'Payment Terms', fr: 'Conditions de Paiement', ar: 'شروط الدفع' },
    descriptions: {
      en: 'Payment terms & due dates',
      fr: 'Conditions & délais de paiement',
      ar: 'شروط الدفع وتواريخ الاستحقاق',
    },
    icon: Wallet,
    group: 'Settings',
    type: 'settings',
    keywords: ['conditions paiement', 'شروط الدفع', 'délai', 'net 30'],
  },
  {
    path: '/configurations/sequences',
    labels: { en: 'Sequences', fr: 'Séquences', ar: 'تسلسلات الأرقام' },
    descriptions: {
      en: 'Document numbering sequences',
      fr: 'Séquences de numérotation',
      ar: 'تسلسلات ترقيم المستندات',
    },
    icon: FileText,
    group: 'Settings',
    type: 'settings',
    keywords: ['séquences', 'numérotation', 'تسلسلات', 'numbering', 'prefix'],
  },
  {
    path: '/configurations/uom',
    labels: { en: 'Units of Measure', fr: 'Unités de Mesure', ar: 'وحدات القياس' },
    descriptions: {
      en: 'Units of measure configuration',
      fr: 'Configuration des unités de mesure',
      ar: 'إعداد وحدات القياس',
    },
    icon: Package,
    group: 'Settings',
    type: 'settings',
    keywords: ['unités mesure', 'وحدات القياس', 'uom', 'kg', 'unit', 'pcs'],
  },
  {
    path: '/configurations/company',
    labels: { en: 'Company Settings', fr: 'Paramètres Société', ar: 'إعدادات الشركة' },
    descriptions: {
      en: 'Company profile & information',
      fr: 'Profil & informations société',
      ar: 'ملف الشركة ومعلوماتها',
    },
    icon: Building2,
    group: 'Settings',
    type: 'settings',
    keywords: ['société', 'entreprise', 'معلومات الشركة', 'company', 'profile', 'logo'],
  },
  {
    path: '/configurations/inventory',
    labels: { en: 'Inventory Settings', fr: 'Paramètres Inventaire', ar: 'إعدادات المخزون' },
    descriptions: {
      en: 'Automatic stock movement settings',
      fr: 'Paramètres des mouvements de stock automatiques',
      ar: 'إعدادات حركات المخزون التلقائية',
    },
    icon: Package,
    group: 'Settings',
    type: 'settings',
    keywords: ['inventaire', 'stock', 'mouvement', 'مخزون', 'حركة', 'warehouse', 'entrepôt'],
  },
];
...
function highlightText(text: string, query: string): React.ReactNode {
  ...
  return (
    <>
      {text.slice(0, idx)}
      <mark
        style={{ background: '#fef08a', color: '#111827', borderRadius: '0.125rem', padding: 0 }}
      >
...
export const Header = ({ isSidebarOpen = false, onMenuToggle }: HeaderProps) => {
  ...
  const filteredRoutes = useMemo(() => {
    ...
    if (!searchQuery.trim()) {
      ...
      const quickRoutes = APP_ROUTES.filter(
        (r) => QUICK_ACCESS_PATHS.includes(r.path) && !recentPaths.includes(r.path),
      );
      base = [...recentRoutes, ...quickRoutes];
    } else {
      const q = searchQuery.toLowerCase().trim();
      base = APP_ROUTES.map((r) => ({ route: r, score: scoreRoute(r, q, lang) }))
  ...
  const handleInstallClick = async () => {
    if (!installPrompt) {
      if (isIOS) toastInfo(t('iosInstallHint'));
      return;
    }
    try {
        ...
        >
          ...
          <div className="flex align-items-center gap-2">
            ...
            <Divider
              ...
              style={{ height: '1.5rem', margin: '0 0.25rem' }}
            />
            ...
            <button
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLButtonElement).style.background = 'rgba(35,90,228,0.07)';
              }}
              onMouseLeave={(e) => {
            ...
            >
              ...
              <ChevronDown
                ...
                style={{ width: '0.875rem', height: '0.875rem', color: '#9ca3af', flexShrink: 0 }}
                strokeWidth={2}
              />
            </button>
            ...
            <OverlayPanel
              ...
              style={{
                ...
                overflow: 'hidden',
                boxShadow: '0 12px 32px rgba(0,0,0,0.15), 0 0 0 1px rgba(0,0,0,0.06)',
              }}
              ...
              <div style={{ padding: '0.375rem 0', direction: language === 'ar' ? 'rtl' : 'ltr' }}>
                {[
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLButtonElement).style.background = item.bg;
                    }}
                    onMouseLeave={(e) => {
                      (e.currentTarget as HTMLButtonElement).style.background = 'transparent';
                    }}
            ...
            return (
              ...
              >
                ...
                >
                  {/* Handle */}
                  <div
                    style={{ display: 'flex', justifyContent: 'center', padding: '0.625rem 0 0' }}
                  >
                    <div
                      style={{
                        width: '2.5rem',
                      ...
                      allFlat.map((route) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <RouteIcon
                                style={{ width: '1.1rem', height: '1.1rem', color: gc.color }}
                                strokeWidth={1.75}
                              />
                            </div>
                            <div
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  <Search
                    style={{ width: '1.5rem', height: '1.5rem', color: '#6366f1', flexShrink: 0 }}
                    strokeWidth={2}
                  />
                  <InputText
                    ref={searchInputRef}
                    ...
                    return (
                      <Button
                        ...
                        style={{
                          ...
                          boxShadow: isActive
                            ? `inset 0 0 0 1.5px ${gc ? gc.color : '#6366f1'}33`
                            : 'none',
                ...
                <div
                  ref={resultsRef}
                  style={{ maxHeight: '26rem', overflowY: 'auto', padding: '0.375rem 0' }}
                >
                  {filteredRoutes.length === 0 ? (
                    ...
                    >
                      ...
                      <p style={{ fontSize: '0.875rem', margin: '0.375rem 0 0', color: '#cbd5e1' }}>
                        {ui.noResultsHint}
                      </p>
                    </div>
                  ) : (
