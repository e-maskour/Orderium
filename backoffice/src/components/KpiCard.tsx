...
export const KpiGrid: React.FC<{ count: number; children: React.ReactNode }> = ({
  count,
  children,
}) => {
...
> = {
  blue: {
    ...
    accentColor: '#235ae4',
    iconShadow: 'rgba(35,90,228,0.26)',
  },
  emerald: {
    gradient: 'linear-gradient(135deg, #10b981, #059669)',
    accentColor: '#059669',
    iconShadow: 'rgba(5,150,105,0.24)',
  },
  amber: {
    gradient: 'linear-gradient(135deg, #f59e0b, #d97706)',
    accentColor: '#d97706',
    iconShadow: 'rgba(217,119,6,0.24)',
  },
  purple: {
    gradient: 'linear-gradient(135deg, #8b5cf6, #7c3aed)',
    accentColor: '#7c3aed',
    iconShadow: 'rgba(124,58,237,0.24)',
  },
  red: {
    gradient: 'linear-gradient(135deg, #f43f5e, #e11d48)',
    accentColor: '#e11d48',
    iconShadow: 'rgba(225,29,72,0.24)',
  },
  green: {
    gradient: 'linear-gradient(135deg, #22c55e, #16a34a)',
    accentColor: '#16a34a',
    iconShadow: 'rgba(22,163,74,0.24)',
  },
  orange: {
    gradient: 'linear-gradient(135deg, #fb923c, #ea580c)',
    accentColor: '#ea580c',
    iconShadow: 'rgba(234,88,12,0.24)',
  },
  indigo: {
    gradient: 'linear-gradient(135deg, #6366f1, #4f46e5)',
    accentColor: '#4f46e5',
    iconShadow: 'rgba(79,70,229,0.24)',
  },
};
        ...
        <div style={{ minWidth: 0, flex: 1 }}>
          ...
          {(subtitle || trend) && (
            ...
            >
              ...
              {subtitle && (
                <p style={{ fontSize: '0.6875rem', color: '#94a3b8', margin: 0, fontWeight: 500 }}>
                  {subtitle}
                </p>
              )}
            </div>
