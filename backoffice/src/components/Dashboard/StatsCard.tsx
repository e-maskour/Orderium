    ...
    return (
        ...
        >
            ...
            <div style={{
                ...
                background: c.light, opacity: 0.55, pointerEvents: 'none',
            }} />
            ...
            <div style={{
                ...
                marginBottom: '0.625rem', position: 'relative',
            }}>
                <p style={{
                ...
                <div style={{
                    width: '2.625rem', height: '2.625rem', borderRadius: '0.75rem',
            ...
            {/* Row 2: big value */}
            <p style={{
                fontSize: valueFontSize, fontWeight: 800, color: '#0f172a',
                margin: '0 0 0.125rem', lineHeight: 1.1, letterSpacing: '-0.025em',
            ...
            {/* Subtitle */}
            {subtitle && (
                <p style={{ fontSize: '0.6875rem', color: '#94a3b8', fontWeight: 500, margin: '0.25rem 0 0', position: 'relative' }}>
                    {subtitle}
                </p>
            )}
            ...
            {/* Trend badge */}
            {trend && (
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.75rem', position: 'relative' }}>
                    <span style={{
            ...
            {progress !== undefined && (
                <div style={{
                    ...
                    background: '#e8ecf2', borderRadius: '9999px', overflow: 'hidden',
                    position: 'relative',
                }}>
                    <div style={{
                        width: `${Math.min(progress, 100)}%`, height: '100%',
                        background: c.gradient, borderRadius: '9999px',
