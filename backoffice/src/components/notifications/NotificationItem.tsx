...
export function NotificationItem({
  ...
  const translatedTitle =
    titleTranslation !== titleKey ? titleTranslation : notification.title || titleKey;
  ...
  let translatedMessage =
    messageTranslation !== messageKey ? messageTranslation : notification.message || messageKey;
