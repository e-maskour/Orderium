...
const match = (prefix: string) => (p: string) => p === prefix || p.startsWith(prefix + '/');
...
const MODULE_CONFIGS: ModuleConf[] = [
  // ── Ventes ─────────────────────────────────────────────────
  {
    ...
    tabs: [
      { labelKey: 'quote', to: '/devis', icon: FileCheck, isActive: match('/devis') },
      {
        ...
        to: '/bons-livraison',
        icon: PackageCheck,
        isActive: match('/bons-livraison'),
      },
      {
        labelKey: 'salesInvoice',
        to: '/factures/vente',
        icon: FileText,
        isActive: (p) => p.startsWith('/factures/vente'),
      },
      {
        labelKey: 'payments',
        to: '/paiements-vente',
        icon: Wallet,
        isActive: match('/paiements-vente'),
      },
    ...
    tabs: [
      {
        ...
        to: '/demande-prix',
        icon: DollarSign,
        isActive: match('/demande-prix'),
      },
      {
        labelKey: 'purchaseOrder',
        to: '/bon-achat',
        icon: ShoppingBag,
        isActive: match('/bon-achat'),
      },
      {
        labelKey: 'purchaseInvoice',
        to: '/factures/achat',
        icon: Receipt,
        isActive: (p) => p.startsWith('/factures/achat'),
      },
      {
        labelKey: 'payments',
        to: '/paiements-achat',
        icon: Wallet,
        isActive: match('/paiements-achat'),
      },
  ...
  // ── Stock ──────────────────────────────────────────────────
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        to: '/warehouses',
        icon: Building2,
        isActive: match('/warehouses'),
      },
      {
        labelKey: 'stockMovements',
        to: '/stock-movements',
        icon: ArrowLeftRight,
        isActive: match('/stock-movements'),
      },
      {
        labelKey: 'inventoryAdjustments',
        to: '/inventory-adjustments',
        icon: SlidersHorizontal,
        isActive: match('/inventory-adjustments'),
      },
    ],
  },
  ...
  // ── Équipe ─────────────────────────────────────────────────
  {
    triggerFn: (p) => match('/users')(p) || match('/roles')(p),
    tabs: [
    ...
    tabs: [
      {
        ...
        to: '/configurations',
        icon: Settings,
        isActive: (p) => p === '/configurations',
      },
      {
        labelKey: 'taxes',
        to: '/configurations/taxes',
        icon: Percent,
        isActive: (p) => p.startsWith('/configurations/taxes'),
      },
      {
        labelKey: 'currencies',
        to: '/configurations/currencies',
        icon: Globe,
        isActive: (p) => p.startsWith('/configurations/currencies'),
      },
      {
        labelKey: 'paymentTerms',
        to: '/configurations/payment-terms',
        icon: Calendar,
        isActive: (p) => p.startsWith('/configurations/payment-terms'),
      },
      {
        labelKey: 'sequences',
        to: '/configurations/sequences',
        icon: Hash,
        isActive: (p) => p.startsWith('/configurations/sequences'),
      },
      {
        labelKey: 'units',
        to: '/configurations/uom',
        icon: Ruler,
        isActive: (p) => p.startsWith('/configurations/uom'),
      },
      {
        labelKey: 'tabInventoryConfig',
        to: '/configurations/inventory',
        icon: Archive,
        isActive: (p) => p.startsWith('/configurations/inventory'),
      },
      {
        labelKey: 'tabCompany',
        to: '/configurations/company',
        icon: Building,
        isActive: (p) => p.startsWith('/configurations/company'),
      },
    ],
  },
];
