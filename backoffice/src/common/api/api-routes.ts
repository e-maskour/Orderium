...
export const API_ROUTES = {
  ...
  INVENTORY_ADJUSTMENTS: {
    ...
    GENERATE_LIST: (warehouseId: number) =>
      `/api/inventory/adjustments/generate-list/${warehouseId}`,
  ...
  DRIVE: {
    ...
    RESTORE_VERSION: (nodeId: string, versionId: string) =>
      `/api/drive/files/${nodeId}/versions/${versionId}/restore`,
    // Sharing
    LIST_SHARES: (nodeId: string) => `/api/drive/nodes/${nodeId}/shares`,
    CREATE_SHARE: (nodeId: string) => `/api/drive/nodes/${nodeId}/shares`,
    UPDATE_SHARE: (nodeId: string, shareId: string) =>
      `/api/drive/nodes/${nodeId}/shares/${shareId}`,
    REVOKE_SHARE: (nodeId: string, shareId: string) =>
      `/api/drive/nodes/${nodeId}/shares/${shareId}`,
    ...
    // Raw MinIO browser
    BROWSE_STORAGE: (prefix?: string) =>
      `/api/drive/browse${prefix ? `?prefix=${encodeURIComponent(prefix)}` : ''}`,
