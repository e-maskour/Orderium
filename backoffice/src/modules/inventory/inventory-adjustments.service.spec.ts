...
import { InventoryAdjustmentService, inventoryAdjustmentService } from './inventory-adjustments.service';
    ...
    API_ROUTES: {
        INVENTORY_ADJUSTMENTS: {
            ...
            GENERATE_LIST: (warehouseId: number) =>
                `/inventory/adjustments/generate-list/${warehouseId}`,
...
describe('InventoryAdjustmentService (backoffice)', () => {
    ...
    describe('getById', () => {
        ...
        it('returns InventoryAdjustment instance with correct status properties', async () => {
            (apiClient.get as any).mockResolvedValue(apiRes({ ...adjustmentApiData, status: 'in_progress' }));
