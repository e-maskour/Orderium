export default {
  ...
  deliveryAnalysis: 'Analyse des bons de livraison',
  count: 'Nombre',
  status: 'Statut',
  validatedCount: 'Validés',
  remaining: 'Reste à payer',
  totalValue: 'Valeur totale',
  deliveryCount: 'Nombre de livraisons',
  documents: 'documents',
  invoices: 'factures',
  quotes: 'Devis',
  deliveries: 'bons',
  ...
  errorPartnerMissingIce: 'Le {partner} doit avoir un numéro ICE pour valider la facture',
  ...
  confirmValidateDocument:
    'Êtes-vous sûr de vouloir valider ce document ? Il ne pourra plus être modifié.',
  ...
  confirmCreateDeliveryNote:
    'Voulez-vous créer un bon de livraison à partir de ce devis ? Toutes les données seront copiées.',
  ...
  confirmCancelDelivery:
    'Êtes-vous sûr de vouloir annuler ce bon de livraison ? Cette action peut être irréversible.',
  ...
  date: 'Date',
  dateDeFacturation: 'Date de facturation',
  dateDeBon: 'Date de bon',
  dateDeDevis: 'Date de devis',
  notes: 'Notes',
  signature: 'Signature',
  signedBy: 'Signé par:',
  comment: 'Commentaire:',
