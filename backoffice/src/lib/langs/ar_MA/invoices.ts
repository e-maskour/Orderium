export default {
  ...
  signQuote: 'توقيع',
  rejectQuote: 'رفض',
  validateDocumentTitle: 'تحقق من المستند',
  devalidateDocumentTitle: 'إلغاء التحقق من المستند',
  createInvoiceTitle: 'إنشاء فاتورة',
  createDeliveryNoteTitle: 'إنشاء وصل تسليم',
  signQuoteTitle: 'توقيع عرض السعر',
  rejectQuoteTitle: 'رفض عرض السعر',
  markAsDeliveredTitle: 'وضع علامة كتم التسليم',
  cancelDeliveryTitle: 'إلغاء وصل التسليم',
