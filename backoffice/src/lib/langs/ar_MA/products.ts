export default {
  ...
  brand: 'علامة تجارية',
  manageBrands: 'إدارة العلامات التجارية للكتالوج',
  ...
  brandWebsite: 'الموقع الإلكتروني',
  enterBrandWebsite: 'https://example.com',
  brandLogo: 'شعار العلامة التجارية',
  categoryImage: 'صورة الفئة',
  imageShownInClientPortal: 'تظهر في بوابة العملاء',
  brandLogoUrl: 'رابط الشعار',
  enterBrandLogoUrl: 'https://example.com/logo.png',
  ...
  createFirstBrand: 'أنشئ علامتك التجارية الأولى للبدء',
  searchBrands: 'ابحث عن علامة تجارية...',
  selectBrand: 'اختر علامة تجارية',
  brandProductCount: 'المنتجات',
  showInactiveBrands: 'إظهار العلامات غير النشطة',
  confirmDeleteBrand: 'هل أنت متأكد من حذف العلامة التجارية "{{name}}"؟',
  ...
  selectProductsToAdd: 'اختر المنتجات المراد إضافتها',
  done: 'تم',
  searchProductPlaceholder: 'ابحث عن منتج...',
  noProductFound: 'لم يتم العثور على أي منتج',
  tryAnotherSearchTerm: 'جرّب كلمة بحث أخرى',
  stockNegative: 'مخزون سالب',
  stockZero: 'مخزون صفري',
  stockPositive: 'مخزون موجب',
  noParentRootCategory: 'بدون أصل (فئة جذرية)',
};
