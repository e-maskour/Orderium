...
const PLAN_BADGES: Record<string, string> = {
    ...
    basic: 'bg-indigo-50 text-indigo-700 ring-indigo-600/10 dark:bg-indigo-900/30 dark:text-indigo-400',
    pro: 'bg-violet-50 text-violet-700 ring-violet-600/10 dark:bg-violet-900/30 dark:text-violet-400',
    enterprise: 'bg-purple-50 text-purple-700 ring-purple-600/10 dark:bg-purple-900/30 dark:text-purple-400',
}
                        ...
                        tenants.map((t) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Plan badge */}
                                    <td className="px-4 py-3">
                                        <span className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium ring-1 ring-inset capitalize ${planBadge}`}>
                                            {t.subscriptionPlan}
                                        </span>
                                    </td>
                                    ...
                                    <td className="px-4 py-3">
                                        {expiry ? (
                                            <span className={`flex items-center gap-1.5 text-xs font-medium ${expiry.urgent ? 'text-red-600 dark:text-red-400' : 'text-amber-600 dark:text-amber-400'}`}>
