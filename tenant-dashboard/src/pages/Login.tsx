            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-800 items-center justify-center p-12">
                ...
                <div className="relative z-10 max-w-md text-white">
                    ...
                    <div className="mt-10 space-y-3">
                        {[
                            { icon: <Zap className="h-4 w-4" />, text: 'Provision new tenant databases instantly' },
                            { icon: <ShieldCheck className="h-4 w-4" />, text: 'Manage lifecycle: activate, suspend, archive' },
                            { icon: <Lock className="h-4 w-4" />, text: 'Track subscriptions, payments & renewals' },
                        ].map(({ icon, text }) => (
