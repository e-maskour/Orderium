...
export default function DeliveredOrders() {
  ...
  orders.forEach((order: Order) => {
    const date = new Date(order.deliveredAt ?? order.createdAt).toLocaleDateString('fr-FR', {
      day: '2-digit',
      month: 'long',
      year: 'numeric',
    });
    ...
    <AppLayout>
      ...
      <div style={{ padding: '0.875rem' }}>
        ...
        {isLoading ? (
          ...
          <EmptyState
            icon="✅"
            title={t('noDeliveredOrders')}
            sub="Vos livraisons complétées apparaîtront ici"
          />
        ) : (
          <div>
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <p style={{ fontSize: '0.8rem', color: '#9ca3af', margin: 0 }}>
          #{order.orderNumber}
          {order.deliveredAt &&
            ` · ${new Date(order.deliveredAt).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}`}
        </p>
      </div>
      ...
      {[0, 1, 2, 3].map((i) => (
        ...
        >
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <div
              style={{ width: '60%', height: '14px', background: '#f3f4f6', borderRadius: '6px' }}
            />
            <div
              style={{ width: '35%', height: '11px', background: '#f3f4f6', borderRadius: '6px' }}
            />
          </div>
          <div
            style={{ width: '20%', height: '16px', background: '#f3f4f6', borderRadius: '6px' }}
          />
        </div>
      ))}
    </div>
