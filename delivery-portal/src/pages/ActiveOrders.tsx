          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
            ...
            >
              <RefreshCw
                size={17}
                color="#fff"
                style={{ animation: isFetching ? 'dlv-spin 1s linear infinite' : 'none' }}
              />
            </button>
          </div>
        </div>
      ...
      <div style={{ padding: '0.875rem' }}>
        {isLoading ? (
          ...
          <EmptyState
            ...
            title={t('error')}
            sub={t('tryAgain')}
            cta={{ label: t('retry'), onClick: () => refetch() }}
          />
        ) : orders.length === 0 ? (
          <EmptyState
            icon="🚚"
            title={t('noInProgressOrders')}
            sub="Vos livraisons actives apparaîtront ici"
          />
        ) : (
...
function ActiveCard({
  ...
  t: (k: any) => string;
  isPending: boolean;
  onAction: (next: ActiveStatus) => void;
}) {
    ...
    >
      ...
      <div style={{ flex: 1, padding: '0.9375rem' }}>
        ...
        >
          ...
          <div
            style={{ width: '9px', height: '9px', borderRadius: '50%', background: badge.stripe }}
          />
        </div>
        ...
        {order.customerAddress && (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.375rem', flex: 1 }}>
              ...
              <span style={{ color: '#6b7280', fontSize: '0.875rem', lineHeight: 1.45 }}>
                {order.customerAddress}
              </span>
            </div>
            <button
        ...
        >
          <span style={{ fontSize: '0.8rem', color: '#9ca3af', fontWeight: 500 }}>
            ...
            {order.items?.length === 1 ? t('itemsCount') : t('articlesSuffix')}
          </span>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <div
                style={{ width: '25%', height: '13px', background: '#f3f4f6', borderRadius: '6px' }}
              />
              <div
                style={{ width: '20%', height: '13px', background: '#f3f4f6', borderRadius: '6px' }}
              />
            </div>
            <div
              style={{ width: '70%', height: '22px', background: '#f3f4f6', borderRadius: '8px' }}
            />
            <div
              style={{ width: '45%', height: '16px', background: '#f3f4f6', borderRadius: '6px' }}
            />
            <div
              style={{
                width: '100%',
...
function EmptyState({
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: '1.1rem', fontWeight: 700, color: '#111827', margin: '0 0 0.5rem' }}>
        {title}
      </p>
