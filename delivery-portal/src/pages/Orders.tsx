      ...
      <div style={{ flex: 1, padding: '0.9375rem' }}>
        ...
        {action && (
          <button
            onClick={(e) => {
              e.stopPropagation();
              onAction(order.orderId, action.nextStatus);
            }}
...
export default function Orders() {
  ...
  const toPickUp = allOrders.filter((o: Order) =>
    ['assigned', 'confirmed'].includes(o.status ?? ''),
  );
    ...
    <AppLayout>
      ...
      >
        {isLoading ? (
          ...
          >
            <p style={{ color: '#dc2626', fontWeight: 700, margin: '0 0 0.5rem' }}>
