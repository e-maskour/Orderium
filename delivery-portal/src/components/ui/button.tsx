  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        gold: "bg-accent text-accent-foreground hover:opacity-90 shadow-md font-semibold",
        terracotta: "bg-primary text-primary-foreground hover:opacity-90 shadow-md font-semibold",
        teal: "bg-teal text-teal-foreground hover:opacity-90 shadow-sm",
        cart: "bg-accent text-accent-foreground hover:opacity-90 shadow-lg font-bold text-base",
      },
      size: {
        ...
        touchLg: "h-16 px-8 text-lg min-w-[160px]",
      },
    },
    defaultVariants: {
      variant: "default",
