import { AlertTriangle, XCircle, PauseCircle, BanIcon, Lock } from 'lucide-react';
...
> = {
  trial_expired: {
    ...
    description:
      'The free trial has expired. Please contact the administrator to activate a subscription and regain access.',
    accent: '#d97706',
  },
  subscription_expired: {
    ...
    description:
      'The subscription has expired. Please contact the administrator to renew and restore access.',
    accent: '#ea580c',
  },
  suspended: {
    ...
    description:
      'This account has been temporarily suspended. Please contact your administrator for more information.',
    accent: '#dc2626',
  },
  disabled: {
    ...
    description:
      'This account has been disabled. Please contact your administrator to re-enable access.',
    accent: '#6b7280',
  },
  portal_disabled: {
    icon: <Lock size={48} color="#6b7280" />,
    title: 'Portal Access Disabled',
    description:
      'Access to the delivery portal has been disabled by the administrator. Please contact them for more information.',
    accent: '#6b7280',
  },
};
