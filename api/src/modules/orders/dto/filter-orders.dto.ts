import { IsOptional, IsString, IsDateString, IsNumber, IsBoolean, IsArray } from 'class-validator';
...
export class FilterOrdersDto {
  ...
  @ApiProperty({ required: false, description: 'Delivery status filter', type: [String] })
  @IsOptional()
  @Transform(({ value }) => {
