...
export const DEFAULT_NOTIFICATION_TEMPLATES: NotificationTemplateDefault[] = [
    ...
    // ─── Admin → Delivery Portal ────────────────────────────────────────────────
    {
        ...
        bodyFr: '🚚 Commande #{{orderNumber}} vous a été assignée. Client: {{clientName}}.',
        titleAr: 'تكليف جديد',
    ...
    },
    {
        ...
        description: 'Envoyé au nouveau livreur quand l\'admin réassigne une commande.',
        priority: 'HIGH',
        enabled: true,
    },
    {
        ...
        bodyFr: '❌ La commande #{{orderNumber}} qui vous était assignée a été annulée.',
        titleAr: 'تم إلغاء الطلب',
        bodyAr: '❌ تم إلغاء الطلب #{{orderNumber}} المكلّف إليك.',
        description: 'Envoyé au livreur quand l\'admin annule une commande assignée.',
        priority: 'HIGH',
        enabled: true,
    },
    ...
    // ─── Admin → Client Portal ──────────────────────────────────────────────────
    {
        ...
        description: 'Envoyé au client quand l\'admin marque sa commande comme livrée.',
        priority: 'MEDIUM',
        enabled: true,
    },
    {
    ...
    },
    {
        ...
        bodyFr: '📦 Votre commande #{{orderNumber}} a été assignée à {{driverName}}.',
        titleAr: 'طلبك في الطريق',
        bodyAr: '📦 تم تعيين {{driverName}} لتوصيل طلبك #{{orderNumber}}.',
        description: 'Envoyé au client quand l\'admin assigne sa commande à un livreur.',
        priority: 'MEDIUM',
        enabled: true,
    },
    {
    ...
    // ─── Delivery → Admin + Client ──────────────────────────────────────────────
    {
        ...
        bodyFr: '🚴 {{driverName}} est en route pour livrer la commande #{{orderNumber}} à {{clientName}}.',
        titleAr: 'جاري التوصيل',
        bodyAr: '🚴 {{driverName}} في الطريق لتوصيل الطلب #{{orderNumber}} إلى {{clientName}}.',
    ...
    },
    {
        ...
        bodyFr: '🚴 {{driverName}} est en route avec votre commande #{{orderNumber}}.',
    ...
    },
    {
        ...
        portal: 'backoffice',
        titleFr: 'Commande livrée',
        bodyFr: '✅ {{driverName}} a livré la commande #{{orderNumber}} à {{clientName}}.',
        titleAr: 'تم التسليم',
        bodyAr: '✅ قام {{driverName}} بتسليم الطلب #{{orderNumber}} إلى {{clientName}}.',
    ...
    },
    {
        ...
        bodyFr: '⚠️ {{driverName}} a signalé un échec de livraison pour la commande #{{orderNumber}}.',
        titleAr: 'فشل التسليم',
    ...
    },
    {
        ...
        portal: 'client',
        titleFr: 'Échec de livraison',
        bodyFr: '⚠️ Votre commande #{{orderNumber}} n\'a pas pu être livrée. Nous vous recontactons.',
        titleAr: 'فشل التسليم',
        bodyAr: '⚠️ تعذّر تسليم طلبك #{{orderNumber}}. سنتواصل معك قريباً.',
        description: 'Envoyé au client quand le livreur signale un échec de livraison.',
        priority: 'HIGH',
        enabled: true,
    },
    ...
    // ─── Stock Alerts → Backoffice ───────────────────────────────────────────────
    {
        ...
        bodyFr: '⚠️ Le stock de "{{productName}}" est bas ({{stock}} unités restantes, seuil: {{threshold}}).',
        titleAr: 'مخزون منخفض — {{productName}}',
        bodyAr: '⚠️ مخزون "{{productName}}" منخفض ({{stock}} وحدات متبقية، الحد: {{threshold}}).',
        description: 'Envoyé aux admins quand le stock d\'un produit atteint le seuil d\'alerte.',
        priority: 'HIGH',
        enabled: true,
    },
    {
    ...
    // ─── Payment Due Alerts → Backoffice ─────────────────────────────────────────
    {
        ...
        bodyFr: '💰 La commande #{{orderNumber}} de {{clientName}} a un solde impayé de {{amount}} DH (échéance: {{dueDate}}).',
        titleAr: 'دفعة متأخرة — طلب',
        bodyAr: '💰 طلب #{{orderNumber}} من {{clientName}} لديه رصيد غير مدفوع {{amount}} درهم (تاريخ الاستحقاق: {{dueDate}}).',
        description: 'Envoyé quotidiennement aux admins pour les commandes avec paiements en retard.',
        priority: 'HIGH',
        enabled: true,
    },
    {
        ...
        bodyFr: '💰 La facture #{{invoiceNumber}} de {{clientName}} a un solde impayé de {{amount}} DH (échéance: {{dueDate}}).',
        titleAr: 'فاتورة غير مدفوعة',
        bodyAr: '💰 فاتورة #{{invoiceNumber}} من {{clientName}} لها رصيد غير مدفوع {{amount}} درهم (تاريخ الاستحقاق: {{dueDate}}).',
        description: 'Envoyé quotidiennement aux admins pour les factures en retard de paiement.',
        priority: 'HIGH',
        enabled: true,
    },
    ...
    },
    {
        ...
        bodyFr: '📈 Résumé du {{date}}: {{ordersCount}} commandes, chiffre d\'affaires {{amount}} DH.',
        titleAr: 'ملخص مبيعات اليوم',
        bodyAr: '📈 ملخص {{date}}: {{ordersCount}} طلبات، رقم الأعمال {{amount}} درهم.',
    ...
    },
    {
        ...
        bodyFr: '📊 Semaine du {{weekStart}}: {{ordersCount}} commandes, revenus totaux {{amount}} DH.',
        titleAr: 'تقرير الإيرادات الأسبوعي',
        bodyAr: '📊 أسبوع {{weekStart}}: {{ordersCount}} طلبات، إجمالي الإيرادات {{amount}} درهم.',
    ...
    },
    {
        ...
        bodyFr: '⏳ La commande #{{orderNumber}} est en attente depuis {{minutes}} minutes.',
        titleAr: 'طلب غير معيّن',
        bodyAr: '⏳ الطلب #{{orderNumber}} في الانتظار منذ {{minutes}} دقيقة.',
        description: 'Envoyé aux admins si une commande reste non assignée trop longtemps.',
        priority: 'MEDIUM',
        enabled: false,
    },
];
