...
export class RenameOrderNumberColumn1769310000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "UQ_orders_number"`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "UQ_orders_orderNumber" UNIQUE ("orderNumber")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "UQ_orders_orderNumber"`);
        
        // Make 'orderNumber' nullable again
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "orderNumber" DROP NOT NULL`);
        
        // Add 'number' column back
        await queryRunner.query(`ALTER TABLE "orders" ADD "number" character varying(50)`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "number" SET NOT NULL`);
        
        // Add unique constraint to 'number'
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "UQ_orders_number" UNIQUE ("number")`);
