...
export class AddBusinessFieldsToPartners1768561134072 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "partners" ADD "if" character varying(50)`,
    );
    await queryRunner.query(
      `ALTER TABLE "partners" ADD "cnss" character varying(50)`,
    );
    await queryRunner.query(
      `ALTER TABLE "partners" ADD "rc" character varying(50)`,
    );
    await queryRunner.query(
      `ALTER TABLE "partners" ADD "patente" character varying(50)`,
    );
  }
