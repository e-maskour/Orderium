...
export class AddInvoicedStatusToOrders1769518435103 implements MigrationInterface {
  name = 'AddInvoicedStatusToOrders1769518435103';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum_old" AS ENUM('draft', 'validated', 'in_progress', 'delivered', 'cancelled')`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ALTER COLUMN "status" DROP DEFAULT`,
    );
