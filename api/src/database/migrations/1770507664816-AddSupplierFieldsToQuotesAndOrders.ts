...
export class AddSupplierFieldsToQuotesAndOrders1770507664816 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "supplierName" character varying(255)`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "supplierPhone" character varying(50)`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "quotes" ADD "supplierName" character varying(255)`,
    );
    await queryRunner.query(
      `ALTER TABLE "quotes" ADD "supplierPhone" character varying(50)`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "quotes" DROP COLUMN "supplierAddress"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "supplierAddress"`,
    );
