...
export class CreateCategoryModule1769085748785 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "portal" ADD CONSTRAINT "FK_76c3a13509109c5f1681217a129" FOREIGN KEY ("deliveryId") REFERENCES "delivery_persons"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
