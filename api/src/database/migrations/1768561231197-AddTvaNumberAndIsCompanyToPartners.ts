...
export class AddTvaNumberAndIsCompanyToPartners1768561231197 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "partners" ADD "tvaNumber" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "partners" ADD "isCompany" boolean NOT NULL DEFAULT false`);
    }
