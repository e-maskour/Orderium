...
export class RemovePaidStatusFromInvoices1768587933293 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "referenceNumber"`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "referenceNumber" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "invoices" ADD "paidStatus" integer NOT NULL DEFAULT '0'`);
