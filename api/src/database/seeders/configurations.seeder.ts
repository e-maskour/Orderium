        ...
        sequences: [
          {
            ...
            format: 'FA YYYY-MM-XXXX',
            nextDocumentNumber: `${'FA'} ${today.getFullYear()}-${today.getMonth() + 1}-0001`,
          ...
          },
          {
            ...
            nextDocumentNumber: `${'PA'} ${today.getFullYear()}-${today.getMonth() + 1}-0001`,
            realTimeNextNumber: 1,
          },
          {
            id: 'seq_quote_001',
            ...
            nextDocumentNumber: `${'DV'} ${today.getFullYear()}-${today.getMonth() + 1}-0001`,
            realTimeNextNumber: 1,
          },
          {
            ...
            nextDocumentNumber: `${'BL'} ${today.getFullYear()}-${today.getMonth() + 1}-0001`,
            realTimeNextNumber: 1,
          },
          {
            ...
            nextDocumentNumber: `${'BA'} ${today.getFullYear()}-${today.getMonth() + 1}-0001`,
            realTimeNextNumber: 1,
          },
          {
            id: 'seq_payment_001',
            ...
            nextDocumentNumber: `${'PAY'} ${today.getFullYear()}-${today.getMonth() + 1}-0001`,
            realTimeNextNumber: 1,
          },
          {
            id: 'seq_receipt_001',
            ...
            nextDocumentNumber: `${today.getFullYear()}-${today.getMonth() + 1}-${today.getDate()}-0001`,
            realTimeNextNumber: 1,
          },
          {
            id: 'seq_order_001',
            name: 'Commandes POS (Client / Admin)',
            prefix: 'CMD',
            suffix: '',
            isActive: true,
            createdAt: today.toISOString(),
            ...
            nextDocumentNumber: `CMD ${today.getFullYear()}-${(today.getMonth() + 1).toString().padStart(2, '0')}-0001`,
            realTimeNextNumber: 1,
          },
          {
            id: 'seq_request_price_001',
            ...
            monthInPrefix: true,
            trimesterInPrefix: false,
            format: 'DP YYYY-MM-XXXX',
            nextDocumentNumber: `${'DP'} ${today.getFullYear()}-${today.getMonth() + 1}-0001`,
            realTimeNextNumber: 1,
          },
        ],
      },
